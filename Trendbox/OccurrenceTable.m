...
#import "OccurenceTable.h"
#import "TaskCell.h"
#import <Dropbox/Dropbox.h>

@interface OccurenceTable () <UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate>
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    __weak OccurenceTable *slf = self;
...
- (void)update:(NSDictionary *)changedDict {
    ...
    [self reloadRowsAtIndexPaths:updates withRowAnimation:UITableViewRowAnimationAutomatic];
    ...
    [self insertRowsAtIndexPaths:inserts withRowAnimation:UITableViewRowAnimationAutomatic];
}
